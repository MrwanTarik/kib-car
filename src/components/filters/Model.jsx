  ...
  return (
    <div className="h-full">
      ...
      >
        <summary
          disabled={!brandId}
          className="flex items-center justify-between w-full h-full px-5 bg-white border-none rounded-lg shadow-md cursor-pointer btn shadow-input hover:bg-stone-100"
        >
